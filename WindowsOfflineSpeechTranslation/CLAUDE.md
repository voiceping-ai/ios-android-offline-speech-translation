...
**DO NOT create, boot, or run iOS Simulators or Android Emulators.** All testing must be done on physical devices or native builds only.
...
Disk space is severely limited. Emulator/simulator images consume 15-35+ GB.
